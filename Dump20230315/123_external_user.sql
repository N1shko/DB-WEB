...
CREATE TABLE `external_user` (
  ...
  `sup_id` int NOT NULL,
  PRIMARY KEY (`user_id`),
  UNIQUE KEY `ext_id_UNIQUE` (`user_id`),
...
INSERT INTO `external_user` VALUES (1,'supplier1','hello',NULL,1),(2,'supplier2','hello',NULL,2),(3,'supplier3','hello',NULL,3),(4,'supplier4','hello',NULL,4),(5,'supplier5','hello',NULL,5),(6,'supplier6','hello',NULL,6),(7,'supplier7','hello',NULL,7);
